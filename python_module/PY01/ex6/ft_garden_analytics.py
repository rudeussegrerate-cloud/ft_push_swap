...
class Tree(Plant):
	def	__init__(self, name: str, height: float, p_age: int, trunk_diameter: float) -> None:
		super().__init__(name, height, p_age)
	...
	class stat(Plant.stat):
		...
		def set_shade(self, value: int) -> None:
			self._shade += value
...
class Vegetable(Plant):
	def	__init__(self, name: str, height: float, p_age: int, harvest_season:str, nutritional_value: float) -> None:
		super().__init__(name, height, p_age)
