# importingr all the required libraries
...
img = pygame.image.load("assets/char.png")
...
while True:
    ...
    if event.type == KEYDOWN:  
        ...
        if event.key == K_LEFT:  
            move_x = -0.9  # object moves -0.3 towards x axis
            print("pressed LEFT")
        elif event.key == K_RIGHT:  
            move_x = +0.9  # object moves 0.3 towards x axis
            print("pressed RIGHT")
        elif event.key == K_UP: 
            move_y = -0.9  # object moves -0.3 towards y axis
            print("pressed UP")
        ...
        # press left CTRL button
            ...
            img = pygame.image.load("assets/char1.png")
